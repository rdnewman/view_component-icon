module ViewComponent
  module Icon
    module Heroicon
      ...
      # micro-style Heroicon icon path components.
      #
      # @see https://heroicons.com/micro
      # @api private
      class MicroIconComponent < Base
        self.style = :micro

        # TODO: convert to standard REM size from VIEWPORT and support tailwind separately
        self.default_size = 4
        ...
        self.canonical_names = [
          ...
          :arrow_left_end_on_rectangle, :arrow_left_start_on_rectangle,
          :arrow_long_down, :arrow_long_left, :arrow_long_right, :arrow_long_up,
          :arrow_path, :arrow_path_rounded_square, :arrow_right, :arrow_right_circle,
          :arrow_right_end_on_rectangle, :arrow_right_start_on_rectangle,
          ...
          :microphone, :minus, :minus_circle, :moon, :musical_note, :newspaper,
          :no_symbol, :numbered_list, :paint_brush, :paper_airplane, :paper_clip,
          :pause, :pause_circle, :pencil, :pencil_square, :percent_badge, :phone,
          :phone_arrow_down_left, :phone_arrow_up_right, :phone_x_mark, :photo, :play,
          :play_circle, :play_pause, :plus, :plus_circle, :power,
